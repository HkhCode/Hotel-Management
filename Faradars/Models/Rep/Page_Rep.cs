    ...
    public class Page_Rep : IDisposable
    {
        ...
        public Page GetPage(int id)
        {
            ...
            foreach (var item in qtasvir.Where(a => a.Tasavir_Asli == false))
            {
                ...
                t.Url = "/img/img/hotel-page/slider/" + item.Tasavir_Name + "";
                lstasvir.Add(t);
            }
            ...
            {
                var ostan = db.ostanHotels
                 .Where(a => a.Ostan_ID == item.Jozeyat_OstanID)
                 .FirstOrDefault();
                ...
                lstjozeyat.Ostan = ostan == null ? "خارج از ایران" : ostan.Ostan_Name;
            ...
            p.lstjozeyats = list1;
            p.imgUrl = "/img/img/" + qtasvir.Where(a => a.Tasavir_Asli.Equals(true)).FirstOrDefault().Tasavir_Name + "";
            return p ?? null;
        ...
        public Rezerv getrezervhotel(int id)
        {
            ...
            r.Tasvir = "/img/img/" + tasvir.Tasavir_Name + "";
            r.Adres = q.Adres;
